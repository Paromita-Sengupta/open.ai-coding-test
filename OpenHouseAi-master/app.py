...
from dbSetup import initDB
from data import extractActionToData, extractUserToData
...
<p>This is OpenHouse.ai backend coding challenge </p>
<p>Author: Paromita Sengupta </p>
'''
...
@app.route('/action/all', methods=['GET'])
def api_actions_all():
    conn = sqlite3.connect(db_path)
    conn.row_factory = dict_factory
    cur = conn.cursor()
